...
public class P2shP2wpkhBtcLockSenderTest {
    ...
    public void throws_exception_if_transaction_doesnt_have_witness() throws BtcLockSenderParseException {
        new P2shP2wpkhBtcLockSender(new BtcTransaction(networkParameters));
    }
    ...
    @Test(expected = BtcLockSenderParseException.class)
    public void throws_exception_if_key_not_compressed() throws BtcLockSenderParseException {
    ...
    public void gets_p2sh_p2wpkh_btc_lock_sender_from_raw_transaction() throws BtcLockSenderParseException {
        String rawTx = "020000000001017001d967a340069c0b169fcbeb9cb6e0d78a27c94a41acbce762abc695aefab1000000001716001" +
                "4cfa63de9979e2a8005e6cb516b86202860ff3971ffffffff0200c2eb0b0000000017a914291a7ddc558810708149a731f39" +
                "cd3c3a8782cfd870896e1110000000017a91425a2e67511a0207c4387ce8d3eeef498a4782e64870247304402207e0615f44" +
                "0bbc50351fb5d8839b3fae6c74f652c9ffc9291008f4ea39f9565980220354c734511a0560367b300eecb1a7472317a99546" +
                "2622e06ee91cbe0517c17e1012102e87cd90f3cb0d64eeba797fbb8f8ceaadc09e0128afbaefb0ee9535875ea395400000000";
        BtcTransaction tx = new BtcTransaction(networkParameters, Hex.decode(rawTx));
